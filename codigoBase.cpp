...
class Analisis{
    ...
    public:
        Analisis(char input[100]){
            ...
            ts.Insertar("animacion",ANIMACION,"pclave",vacio,vacio);
            ts.Insertar("iniciar",INICIAR,"pclave",vacio,vacio);
            ts.Insertar("caminarad",CAMINARAD,"pclave",vacio,vacio);
            ts.Insertar("caminarat",CAMINARAT,"pclave",vacio,vacio);
            ts.Insertar("saltar",SALTAR,"pclave",vacio,vacio);
            ts.Insertar("girar",GIRAR,"pclave",vacio,vacio);
            ts.Insertar("hagachar",HAGACHAR,"pclave",vacio,vacio);
            ts.Insertar("mover",MOVER,"pclave",vacio,vacio);
            ts.Insertar("(",APARENT,"pclave",vacio,vacio);
            ts.Insertar(")",CPARENT,"pclave",vacio,vacio);
            ...
            ts.Insertar(".",PUNTO,"pclave",vacio,vacio);
            ts.Insertar(":",DOSPUNT,"pclave",vacio,vacio);
            ts.Insertar(">",FLECHA,"pclave",vacio,vacio);
            ts.Insertar("po",PERSONAJE,"pclave",vacio,vacio);
           // ts.Insertar("accion",ACCION,"pclave",vacio,vacio);
           // ts.Insertar("numer",NUMER,"pclave",vacio,vacio);
